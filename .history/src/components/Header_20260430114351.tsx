        ...
        <nav className="flex items-center">
          {isLoggedIn ? (
            <div className="flex items-center gap-6">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger>
                  <div className="flex items-center gap-2 cursor-pointer group border rounded-md px-4 py-2 bg-[#F28322] hover:bg-[#E07604] shadow-md">
                    <div className="text-white text-2xl group-hover:text-gray-100 transition-colors">
                      <UserCircle size={26} strokeWidth={2} />
                    </div>
                    <span className="font-bold text-white text-base hidden sm:block group-hover:text-gray-100 transition-colors">
                      {userName}
                    </span>
                  </div>
                </DropdownMenuTrigger>
