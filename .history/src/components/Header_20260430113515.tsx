        ...
        <nav className="flex items-center">
          {isLoggedIn ? (
            <div className="flex items-center gap-6">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger>
                  <div className="flex items-center gap-2 cursor-pointer group border rounded-md px-4 py-2 bg-[#F28322] hover:bg-[#E05C04]">
                    <div className="text-white group-hover:text-gray-100 transition-colors">
