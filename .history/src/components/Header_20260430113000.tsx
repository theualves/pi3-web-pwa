              ...
              <DropdownMenu>
                <DropdownMenuTrigger>
                  <div className="flex items-center gap-2 cursor-pointer group border rounded-md p-2 bg-[#F28322] hover:bg-[#C76C1C]">
                    <div className="text-white group-hover:text-gray-700 transition-colors">
                      <UserCircle size={26} strokeWidth={1.5} />
                    </div>
                    <span className="font-bold text-white hidden sm:block group-hover:text-[#35577D] transition-colors">
                      {userName}
                    </span>
                  </div>
                </DropdownMenuTrigger>
